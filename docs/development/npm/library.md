...
TODO: Explain what will come with the library template
...
Once you are ready to publish your library, create an npm registry account if you haven't already, and follow the online guides on publishing your library with Bun/npm manually, or provide an npm token in your github repository secrets to utilize the included GitHub Action.