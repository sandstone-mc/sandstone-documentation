...
Data Variables are just an instance of a Data Point; you can use [all the methods](data#data-points) they have, including all operations: `select`, `set`, `merge`, `append`, `prepend`, `insert`, `remove`, `slice`, `equals`...