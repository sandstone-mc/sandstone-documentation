...
type Props = { height: number, code?: string, encodedCode?: string, filename?: string, baseImports?: string[], children?: string }
...
export const InteractiveSnippet = (props: Props) => {
  ...
  }, [editorValue, editorErrors, isBrowser, hasBeenVisible])
